...
data_root = '/hy-tmp/datasets/VOCdevkit/'
dataset_type = 'CocoDataset'
default_hooks = dict(
    checkpoint=dict(interval=7, save_best='auto', type='CheckpointHook'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        backend_args=None,
        data_prefix=dict(img='/hy-tmp/datasets/VOCdevkit//'),
        data_root='/hy-tmp/datasets/VOCdevkit/',
        pipeline=[
...
test_evaluator = dict(
    ann_file='/hy-tmp/datasets/VOCdevkit/voc07_test.json',
    backend_args=None,
    metric='bbox',
    type='CocoMetric')
test_pipeline = [
...
work_dir = './work_dirs/yolov3_d53_8xb8-ms-608-273e_coco_v2'
